...
#
# set name of job
#SBATCH --job-name=unet__ff_image_mod
#
...
#SBATCH --error=unet_ff_image_mod.err
#SBATCH --output=unet_ff_image_mod.out
#
...
cd /home/jarrett.byrnes/floating-forests/floating_forests_deeplearning/scripts/segmentation_model
